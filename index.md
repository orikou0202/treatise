...
一部の生徒にアンケートを取った結果、50%の生徒が「きゃりったーを知らない」と回答したことや、本サービスを利用するために必要になるoffice 365のパスワードを覚えているかという質問に対し、67%もの生徒が「覚えていない・分からない」と回答したことなどから、他学科のユーザーが少ない原因は「宣伝不足」「登録が難しい」の2つであると結論づけた。
...
非常に有意義な卒業制作になりました。   
サービスを公開するという目標は達成することができましたが、マネジメントはうまくいっていませんでした。   
スケジュール管理がうまくいかずテスト工程がおざなりになってしまったり、メンバー間のモチベーションや技術力などの差で作業量が偏ってしまいました。     
しかし、非常に良い経験になりました。   
残った課題をこれからどのようにしていくべきか、というのを勉強していきたいと思います。
